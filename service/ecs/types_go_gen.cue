...
#Attachment: {
	...
	// address.
	Details: [...#KeyValuePair] @go(,[]KeyValuePair)
...
#Cluster: {
	...
	// attachment.
	Attachments: [...#Attachment] @go(,[]Attachment)
	...
	CapacityProviders: [...string] @go(,[]string)
	...
	DefaultCapacityProviderStrategy: [...#CapacityProviderStrategyItem] @go(,[]CapacityProviderStrategyItem)
	...
	Settings: [...#ClusterSetting] @go(,[]ClusterSetting)
	...
	Statistics: [...#KeyValuePair] @go(,[]KeyValuePair)
...
#Container: {
	...
	ExitCode?: null | int32 @go(,*int32)

	// The IDs of each GPU assigned to the container.
	GpuIds: [...string] @go(,[]string)
	...
	ManagedAgents: [...#ManagedAgent] @go(,[]ManagedAgent)
	...
	NetworkBindings: [...#NetworkBinding] @go(,[]NetworkBinding)

	// The network interfaces associated with the container.
	NetworkInterfaces: [...#NetworkInterface] @go(,[]NetworkInterface)
...
#ContainerDefinition: {
	...
	// later.
	DependsOn: [...#ContainerDependency] @go(,[]ContainerDependency)
	...
	// (https://docs.docker.com/engine/reference/run/#security-configuration). This
	// parameter is not supported for Windows containers.
	DnsSearchDomains: [...string] @go(,[]string)
	...
	DockerLabels: {[string]: string} @go(,map[string]string)
	...
	DockerSecurityOptions: [...string] @go(,[]string)
	...
	Environment: [...#KeyValuePair] @go(,[]KeyValuePair)
	...
	// in the Amazon Elastic Container Service Developer Guide.
	EnvironmentFiles: [...#EnvironmentFile] @go(,[]EnvironmentFile)
	...
	// network mode.
	ExtraHosts: [...#HostEntry] @go(,[]HostEntry)
	...
	MemoryReservation?: null | int32 @go(,*int32)
	...
	MountPoints: [...#MountPoint] @go(,[]MountPoint)
	...
	// responses.
	PortMappings: [...#PortMapping] @go(,[]PortMapping)
	...
	// resource is a GPU.
	ResourceRequirements: [...#ResourceRequirement] @go(,[]ResourceRequirement)

	// The secrets to pass to the container. For more information, see Specifying
	// Sensitive Data
	// (https://docs.aws.amazon.com/AmazonECS/latest/developerguide/specifying-sensitive-data.html)
	// in the Amazon Elastic Container Service Developer Guide.
	Secrets: [...#Secret] @go(,[]Secret)
	...
	// (https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-optimized_AMI.html)
	// in the Amazon Elastic Container Service Developer Guide.
	StartTimeout?: null | int32 @go(,*int32)
	...
	// (https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-optimized_AMI.html)
	// in the Amazon Elastic Container Service Developer Guide.
	StopTimeout?: null | int32 @go(,*int32)
	...
	SystemControls: [...#SystemControl] @go(,[]SystemControl)
	...
	// (https://docs.docker.com/engine/reference/run/#security-configuration).
	VolumesFrom: [...#VolumeFrom] @go(,[]VolumeFrom)
...
#ContainerInstance: {
	...
	// operation.
	Attributes: [...#Attribute] @go(,[]Attribute)
	...
	// ECS.
	RegisteredResources: [...#Resource] @go(,[]Resource)
	...
	RemainingResources: [...#Resource] @go(,[]Resource)
...
#Deployment: {
	...
	CapacityProviderStrategy: [...#CapacityProviderStrategyItem] @go(,[]CapacityProviderStrategyItem)
...
#DeploymentConfiguration: {
	...
	MaximumPercent?: null | int32 @go(,*int32)
	...
	MinimumHealthyPercent?: null | int32 @go(,*int32)
}
...
#Device: {
	...
	Permissions: [...#DeviceCgroupPermission] @go(,[]DeviceCgroupPermission)
}
...
#DockerVolumeConfiguration: {
	...
	// (https://docs.docker.com/engine/reference/commandline/volume_create/).
	DriverOpts: {[string]: string} @go(,map[string]string)
...
#EFSVolumeConfiguration: {
	...
	TransitEncryptionPort?: null | int32 @go(,*int32)
}
...
#FirelensConfiguration: {
	...
	Options: {[string]: string} @go(,map[string]string)
}
...
#HealthCheck: {
	...
	StartPeriod?: null | int32 @go(,*int32)
...
#LinuxParameters: {
	...
	// is not supported.
	SharedMemorySize?: null | int32 @go(,*int32)
	...
	// not supported.
	Swappiness?: null | int32 @go(,*int32)
...
#LoadBalancer: {
	...
	ContainerPort?: null | int32 @go(,*int32)
...
#LogConfiguration: {
	...
	// (https://docs.aws.amazon.com/AmazonECS/latest/developerguide/specifying-sensitive-data.html)
	// in the Amazon Elastic Container Service Developer Guide.
	SecretOptions: [...#Secret] @go(,[]Secret)
}
...
#ManagedScaling: {
	...
	InstanceWarmupPeriod?: null | int32 @go(,*int32)
	...
	// used.
	MaximumScalingStepSize?: null | int32 @go(,*int32)
	...
	MinimumScalingStepSize?: null | int32 @go(,*int32)
...
#ProxyConfiguration: {
	...
	Properties: [...#KeyValuePair] @go(,[]KeyValuePair)
...
#Resource: {
	...
	// type.
	StringSetValue: [...string] @go(,[]string)
...
#Service: {
	...
	Deployments: [...#Deployment] @go(,[]Deployment)
	...
	// displayed.
	Events: [...#ServiceEvent] @go(,[]ServiceEvent)

	// The period of time, in seconds, that the Amazon ECS service scheduler ignores
	// unhealthy Elastic Load Balancing target health checks after a task has first
	// started.
	HealthCheckGracePeriodSeconds?: null | int32 @go(,*int32)
	...
	LoadBalancers: [...#LoadBalancer] @go(,[]LoadBalancer)
	...
	PlacementConstraints: [...#PlacementConstraint] @go(,[]PlacementConstraint)

	// The placement strategy that determines how tasks for the service are placed.
	PlacementStrategy: [...#PlacementStrategy] @go(,[]PlacementStrategy)
	...
	ServiceRegistries: [...#ServiceRegistry] @go(,[]ServiceRegistry)
...
#Task: {
	...
	Containers: [...#Container] @go(,[]Container)
	...
	InferenceAccelerators: [...#InferenceAccelerator] @go(,[]InferenceAccelerator)
...
#TaskDefinition: {
	...
	// in the Amazon Elastic Container Service Developer Guide.
	ContainerDefinitions: [...#ContainerDefinition] @go(,[]ContainerDefinition)
	...
	PlacementConstraints: [...#TaskDefinitionPlacementConstraint] @go(,[]TaskDefinitionPlacementConstraint)
	...
	// supported for tasks run on Fargate.
	RequiresAttributes: [...#Attribute] @go(,[]Attribute)
	...
	RequiresCompatibilities: [...#Compatibility] @go(,[]Compatibility)
...
#TaskOverride: {
	...
	ContainerOverrides: [...#ContainerOverride] @go(,[]ContainerOverride)
	...
	InferenceAcceleratorOverrides: [...#InferenceAcceleratorOverride] @go(,[]InferenceAcceleratorOverride)
